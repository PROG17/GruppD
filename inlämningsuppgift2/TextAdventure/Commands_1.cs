    ...
    public class Commands
    {
        ...
        public Commands(string command)
        {
            ...
            if (command.Length >= 3 && command.Substring(0, 6) == "använd")
            {
                ...
                if (Items.Inventory.inventoryList.Exists(Items => Items.name == command.ToUpper().Substring(4))) //Antagligen fel siffra för Substring
                {
                    Console.WriteLine();
                }
                else
            ...
            if (command.Length >= 3 && command.Substring(0, 10) == "plocka upp") //Antagligen fel siffra för Substring
            {
                ...
                {
                    Console.WriteLine("Något vi vill sk stå när saker plockas upp");
                ...
                if (command.Length >= 3 && command.Substring(0, 5) == "släpp") //Antagligen fel siffra för Substring
                {
                    ...
                    if (Items.Inventory.inventoryList.Exists(Items => Items.name == command.ToUpper().Substring(7))) //Antagligen fel siffra för Substring
                    {
                        Console.WriteLine();
